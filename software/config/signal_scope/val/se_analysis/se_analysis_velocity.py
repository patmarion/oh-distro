...
addSignal('POSE_CAMERA_LEFT_VELOCITY', msg.utime, msg.vel[0])

addPlot(timeWindow=5, yLimits=[-1, 1])
addSignal('POSE_BODY', msg.utime, msg.vel[1])
addSignal('POSE_CAMERA_LEFT_VELOCITY', msg.utime, msg.vel[1])

addPlot(timeWindow=5, yLimits=[-1, 1])
addSignal('POSE_BODY', msg.utime, msg.vel[2])
addSignal('POSE_CAMERA_LEFT_VELOCITY', msg.utime, msg.vel[2])
