...
class TrackingTestPanel(TaskUserPanel):
    ...
    def addTasks(self):
        ...
        def addTest(name, pose, side):
            ...
            addTask(rt.DelayTask(name='wait 4 seconds', delayTime=4.0), parent=groupNominal)
            ...
            addTask(rt.DelayTask(name='wait 4 seconds', delayTime=4.0), parent=groupRequested)
        ...
        addTest('raise left arm front with yawed torso', 'arm_front_torso_yaw', 'left')
        addTest('raise right arm front with yawed torso', 'arm_front_torso_yaw', 'right')
        addTest('left hand to right side with bent torso', 'arm_opposite_side_torso_bent', 'left')
        addTest('right hand to left side with bent torso', 'arm_opposite_side_torso_bent', 'right')
        addTest('reach low with the left arm', 'whole_body_left_arm_low', None)
        addTest('reach low with the right arm', 'whole_body_right_arm_low', None)
