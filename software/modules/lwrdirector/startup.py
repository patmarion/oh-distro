'''
Robot-specific modifications for the Kuka LWR
'''
...
def startup(robotSystem, globalsDict=None):
    ...
    assert 'useKuka' in directorConfig['userConfig']
    ...
    tasklaunchpanel.panel.addTaskPanel('Table Demo', tableTaskPanel.widget)
